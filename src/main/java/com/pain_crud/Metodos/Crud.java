...
@RestController
public class Crud implements com.pain_crud.interfaces.Crud {
    ...
    public int montaStatement(Field[] campos, Class<?> classe, Object obj, Connection con, List<String> cp, int tipo, int idobject) throws SQLException{
     ...
     * @param cp Array de string referente aos campos que não tem chave nem outro tipo de relacionamento
     * @param listObjects List Referente ao objeto que é um relacionaento de um para muitos
     * @param campos campos Field do objeto class
     * @param camposAnotacoes campos de anotações
     * @param ids ids dos campos
     */
   public void separaObject(List<Class<?>> objectLocal, List<String>cp, List<Class<?>> listObjects, Field[] campos,List<String> camposAnotacoes,List<String> ids){
